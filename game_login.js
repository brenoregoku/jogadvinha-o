...
document.getElementById("playerAnswer").innerHTML="turno de reposta:"+player2Name;
...
function check()
{
    ...
    if(questionTurn == "player1")
    {
        ...
        document.getElemnetById("playerQuestion").innerHTML = "Turno de Pergunta -" + player2Name;
        
    }
    else{
        questionTurn = "player1";
        document.getElemnetById("playerQuestion").innerHTML = "Turno de Pergunta -" + player1Name;
    }
    if(answerTurn == "player1")
    {
        answerTurn = "player2";
        document.getElemnetById("playerAnswer").innerHTML = "Turno de reposta -" + player2Name;
        
    }
    else{
        AnswerTurn = "player1";
        document.getElemnetById("playerAnswer").innerHTML = "Turno de resposta -" + player1Name;
    }
